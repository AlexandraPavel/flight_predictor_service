...
class XGBRegression:
    ...
    def compute_prediction(self, input_data):
        try:
            ...
            dataframe_logic = dataframe_logic.astype("int")
            dataframe_return_logic = pd.DataFrame(columns=col_list)
            dataframe_return_logic = dataframe_return_logic.astype("int")
            ...
            #print("")
            new_list_1 = [round(x) for x in list(dataframe_logic.iloc[0])[10:61]]
            new_list_2 = [round(x) for x in list(dataframe_return_logic.iloc[0])[10:61]]
            ...
            p2 = "Based on our data, you should be considering " + time_day_dict[dataframe_logic.iloc[0]["Dep_hour"]] + " flights, with " + str(int(dataframe_logic.iloc[0]["layovers"])) + " layovers, from the " + arl[new_list_1.index(1) + 1] + " airline."
            ...
            p5 = "For this one, you should be considering " + time_day_dict[dataframe_return_logic.iloc[0]["Dep_hour"]] + " flights, with " + str(int(dataframe_return_logic.iloc[0]["layovers"])) + " layovers, from the " + arl[new_list_2.index(1) + 1]  + " airline."
